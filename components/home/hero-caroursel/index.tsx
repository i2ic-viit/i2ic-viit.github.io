  ...
  return (
    <div className="embla max-w-5xl relative">
      ...
      <div className="flex flex-wrap justify-center align-center mt-6">
          <Button disabled={prevBtnDisabled} onClick={onPrevButtonClick} variant={'ghost'} className='size-4 mx-1 rounded-full my-0'>
            <ArrowLeft />
          </Button>
          ...
          <Button disabled={nextBtnDisabled} onClick={onNextButtonClick} variant={'ghost'} className='size-4 mx-1 rounded-full my-0'>
            <ArrowRight />
          </Button>
      </div>
